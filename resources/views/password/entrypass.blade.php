    ...
    <div class="page-content">
      ...
      <div class="panel">
        <div class="panel-heading">
          <h3 class="panel-title">Store Password</h3>
        </div>
          ...
          <div class="row row-lg">
            ...
            {!! Form::open(array('url'=> 'passwordstore/store', 'method' => 'post')) !!}
              ...
              <div class="form-group">
                ...
                <input type="text" placeholder="Website name or title" id="title" name="title" class="form-control">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="password" placeholder="password" id="password" name="pre_password" class="form-control">
              </div>
              <!-- End Example Rounded Input -->

              <div class="form-group">
                <h4 class="example-title">Make more secure</h4>
                <input type="password" placeholder="More secure string" id="moresecure" name="moresecure"  class="form-control">
              ...
              <input type="hidden" name="secure_pass" id="sec_pass">
...
@section('page-scripts-bottom')
 <!-- Plugins -->
  ...
  <script type="text/javascript" src="{{ asset('/custom/js/passentry.js') }}"></script>
